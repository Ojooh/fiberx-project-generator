...
const UI_GENERATED_FILES = [
    ...
    { template: "vite.config.mjs.ejs", output: "vite.config.mjs" },
    { template: "jsconfig.json.ejs", output: "jsconfig.json" },
    { template: "postcss.config.mjs.ejs", output: "postcss.config.mjs" },
    ...
    { template: "src/utils/event_system_util.js.ejs", output: "src/utils/event_system_util.js" },
    { template: "src/utils/encryptor_decryptor_util.js.ejs", output: "src/utils/encryptor_decryptor_util.js" },
    ...
    { template: "src/utils/content_manager_util.js.ejs", output: "src/utils/content_manager_util.js" },
    { template: "src/utils/local_storage_manager_util.js.ejs", output: "src/utils/local_storage_manager_util.js" },
    { template: "src/utils/index_util.js.ejs", output: "src/utils/index_util.js" },
    { template: "src/modules/base_app/controllers/base_app_controller.js.ejs", output: "src/modules/base_app/controllers/base_app_controller.js" },
    { template: "src/enums/constants.enums.js.ejs", output: "src/enums/constants.enums.js" },
